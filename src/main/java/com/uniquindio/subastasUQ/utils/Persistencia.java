...
public class Persistencia {
    public static final String RUTA_USUARIOSTxt = "2023Proyecto/src/main/resources/persistencia/archivos/Archivos/archivoUsuarios.txt";
    public static final String RUTA_USUARIOSXML="2023Proyecto/src/main/resources/persistencia/archivos/model.xml";
    ...
    public static final String RUTA_SUBASTA_LOG="2023Proyecto/src/main/resources/persistencia/archivos/log/SubastaLog.txt";

    public static final String RUTA_TRANSACCIONESTxt = "2023Proyecto/src/main/resources/persistencia/archivos/Archivos/objeto_Transaccion.txt";
